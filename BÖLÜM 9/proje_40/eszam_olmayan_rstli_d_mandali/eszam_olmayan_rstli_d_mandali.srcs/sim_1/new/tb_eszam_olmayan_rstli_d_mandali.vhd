...
entity tb_eszam_olmayan_rstli_d_mandali is
end tb_eszam_olmayan_rstli_d_mandali;
	
architecture Behavioral of tb_eszam_olmayan_rstli_d_mandali is
	
  component eszam_olmayan_rstli_d_mandali
  Port ( 
    in_clk : in std_logic;
    in_rst : in std_logic;
...
begin
  ...
  eszam_olmayan_rstli_d_mandali_map :
  eszam_olmayan_rstli_d_mandali port map(
    in_clk => in_clk,
    in_rst => in_rst,
    in_giris => in_giris,
    out_cikis => out_cikis,
